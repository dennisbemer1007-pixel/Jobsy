...
### Changed
- Homepage PageSpeed: `app.css` laadt non-blocking (`media=print` + onload), `app-core`/`blazor.web.js` met `defer`, MapLibre pas na idle/IntersectionObserver. `#job-map` reserveert 300px / 450px (desktop vanaf 768px) om CLS te voorkomen; logo-`<img>` valt terug op `/images/lobsy-256.webp` en daarna een SVG.
