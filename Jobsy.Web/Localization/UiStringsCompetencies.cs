...
internal static class UiStringsCompetencies
{
    ...
    {
        ["Competency.Title"] = "Quick-Scan",
        ["Competency.Section"] = "Competenties",
        ["Competency.Lead"] = "Vijfentwintig korte stellingen (ca. 3 minuten): Big Five / OCEAN plus RIASEC-beroepsinteresses. We maken tags voor matching en de anonieme talentpool.",
        ["Competency.ScienceNote"] = "De vragen rusten op gevalideerde principes (Big Five / Mini-IPIP en RIASEC). Sommige stellingen zijn omgekeerd geformuleerd voor een eerlijk beeld.",
        ...
        ["Competency.Q21"] = "Ik werk graag met machines, gereedschap of buiten in de praktijk.",
        ["Competency.Q22"] = "Ik onderzoek graag hoe iets werkt of waarom iets zo is.",
        ["Competency.Q23"] = "Ik bedenk graag creatieve of visuele oplossingen.",
        ["Competency.Q24"] = "Ik help graag mensen of werk graag in een team met klanten.",
        ["Competency.Q25"] = "Ik neem graag initiatief en overtuig anderen van een plan.",
        ["Competency.DeepUpsell"] = "Wil je een diepgaand inzicht in jouw unieke werkstijl en een officiële PDF-rapportage voor je sollicitaties? Ontgrendel de uitgebreide diepte-analyse voor € 2,99.",
    ...
    private static Dictionary<string, string> En() => new(StringComparer.OrdinalIgnoreCase)
    {
        ...
        ["Competency.Lead"] = "Twenty-five short statements (about 3 minutes): Big Five / OCEAN plus RIASEC career interests. We turn your answers into four work competencies: teamwork, drive for results, stress resilience and innovation.",
        ...
        ["Competency.Q21"] = "I like working with machines, tools, or outdoors.",
        ["Competency.Q22"] = "I like investigating how things work or why they are that way.",
        ["Competency.Q23"] = "I like inventing creative or visual solutions.",
        ["Competency.Q24"] = "I like helping people or working with customers in a team.",
        ["Competency.Q25"] = "I like taking initiative and persuading others of a plan.",
        ["Competency.DeepUpsell"] = "Want a deep insight into your unique work style and an official PDF report for applications? Unlock the extended deep analysis for € 2.99.",
