...
internal static class UiStringsCompetencies
{
    ...
    private static Dictionary<string, string> Nl() => new(StringComparer.OrdinalIgnoreCase)
    {
        ...
        ["Competency.PrivacyNote"] = "Je antwoorden blijven in jouw account. Werkgevers zien ze niet. We gebruiken de scores alleen om vacatures op jouw profiel voor te stellen. Export en wissen kan via Mijn gegevens. Meer in de",
