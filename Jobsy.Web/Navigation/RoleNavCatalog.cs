...
public static class RoleNavCatalog
{
    ...
    [
        ...
        new("Nav.Settings", "/admin/settings", NavIcons.Settings,
            ["/admin/integrations", "/admin/users", "/admin/logging", "/admin/feedback", "/admin/wages", "/admin/masterdata", "/admin/exclusivity", "/admin/notifications", "/admin/company", "/admin/about", "/admin/marketing-flyer", "/admin/api-keys", "/admin/cnames", "/admin/vacancy-categories", "/admin/mail-test"])
    ];
