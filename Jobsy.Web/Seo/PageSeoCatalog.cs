...
public static partial class PageSeoCatalog
{
    ...
    public static IReadOnlyDictionary<string, PageSeoEntry> Exact { get; } =
        new Dictionary<string, PageSeoEntry>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            ["/candidate/disc"] = Private("Disc.Title", "Seo.PrivateDescription"),
            ...
            ["/candidate/deep-analysis/disc"] = Private("Deep.DiscTitle", "Seo.PrivateDescription"),
            ...
            ["/employer/talent"] = Private("Talent.Title", "Seo.PrivateDescription"),
            ["/employer/talent-contacts"] = Private("Talent.EmployerContactsTitle", "Seo.PrivateDescription"),
