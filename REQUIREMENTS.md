...
- **Functie-Fit Checker** (“Past dit bij mij?”): gated tot beide 25-vragen quick-scans klaar zijn; vrije functietitel **of een concrete vacature** → match-% / sterktes / gat / groeistappen; bij vacature: cultuur-blok + dynamische checklist formele randvoorwaarden (hoog/laag drempel) + opleidingen-CTA bij een papieren gat; upsell 150-vragen analyse
