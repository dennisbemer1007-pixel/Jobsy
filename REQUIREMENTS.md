...
- **Functie-Fit Checker** (“Past dit bij mij?”): gated tot beide 25-vragen quick-scans klaar zijn; vrije functietitel **of een concrete vacature** → **4 stappen** (overall match-% uit reistijd/uren + cultuur/OCEAN + formele eisen; waar je matcht; wat je mist; actie/upskilling) + vergelijkbare functies + live vacatures in Den Haag/Westland waar je direct kunt starten; bij vacature: cultuur-blok + checklist randvoorwaarden (hoog/laag drempel) + opleidingen-CTA bij een papieren gat; upsell 150-vragen analyse
