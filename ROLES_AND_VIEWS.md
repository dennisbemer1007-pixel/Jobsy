...
| Route | Inhoud |
|-------|--------|
| `/candidate/match` | Match & Swipe: ontgrendel-checklist (basis + opleiding + tests) tot `IsProfileComplete`; daarna alleen relevante vacatures (opleiding/reistijd). Banenkaart blijft breder zoeken. |
