...
|------|------|-------------|
| Overzicht eigen activiteit | `/home` | **Mijn Lobsy Kompas** (tabbladen Mijn profiel / Mijn competenties: grafiek + accordeon met workshops / Mijn beste match / Functiefit checker) + KPI’s sollicitaties/likes/shares |
