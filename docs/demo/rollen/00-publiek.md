...
| Registreren | `/register` | Bedrijf via KVK + wachtwoord; SBI 78 → Intermediair; anders Bedrijfsmanager (Organization = org, BranchOnly = vestiging-als-bedrijf; kan vestigingsmanagers uitnodigen) |
