...
| Kandidaat | Home: Kompas-tabbladen Mijn profiel / Mijn competenties / Mijn beste match / Functiefit checker. | Vier tabs; profiel=sectienav Persoonlijk/Voorkeuren/Beschikbaarheid/CV; competenties=grafiek + accordeon per vaardigheid met uitleg en workshops; beste match=Super-match/Handige verbreding als accordeon + Wat betekent dit voor jou? + opleidingen per beroep; fit=4 stappen Functiefit checker + vergelijkbare functies. |
