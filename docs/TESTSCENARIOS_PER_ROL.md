...
| Bedrijfsmanager | Approve zonder saldo. | Fout of top-up; niet stiekem gratis tenzij Always-free categorie / free-publish-until. |
...
| Bedrijfsmanager | Uitgeven zonder selectie / bedrag 0 / meer dan pot. | Validatie; geen negatief saldo. |
...
| Bedrijfsmanager | Regio zonder vestigingen opslaan / delete met gekoppelde RM. | Validatie of cascade-melding. |
...
| Bedrijfsmanager | Salaristabel: ongeldige tarieven / geen naam. | Validatie. |
...
| Bedrijfsmanager | CSV: ontbrekende verplichte uren/legal flags. | Failed rows; inline edit + **Opnieuw aanbieden**. |
| Bedrijfsmanager | CSV: dagdelen leeg. | Importeert als ‘Tijden in overleg’. |
| Bedrijfsmanager | CSV: verkeerd bestandstype / leeg / te groot. | Fout; geen half-import-crash. |
...
| Bedrijfsmanager | Open `/admin/*`, `/intermediary/team`, `/salesmanager/invoices`. | 403. |
