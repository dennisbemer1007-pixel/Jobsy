...
Account: `kandidaat@jobsy.local` / `Jobsy123!`. Bottom-nav: Zoeken · Bewaard · Sollicitaties · Carrière · Profiel. Hoe werkt Lobsy staat in het account-menu (userknop). Geen TokenWalletChip. Extra accounts: `kandidaat.denhaag@jobsy.local`, `kandidaat.ver@jobsy.local` (reistijd/vangnet).
...
| Kandidaat | How-to: link **Profiel**. | `/profiel`. |
...
| Kandidaat | How-to: secondary **Naar profiel**. | `/profiel`. |
