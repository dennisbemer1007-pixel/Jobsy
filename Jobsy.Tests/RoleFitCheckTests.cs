...
public class RoleFitCheckTests
{
    ...
    public void Gate_copy_and_upsell_match_the_product_spec()
    {
        ...
        Assert.Equal("Mijn beroepen", UiStringsNl("Kompas.TabOccupations"));
    ...
    public void Pages_wire_tabs_and_gated_fit_checker()
    {
        ...
        Assert.Contains("KompasTabs.Fit", kompas, StringComparison.Ordinal);
        ...
        Assert.Contains("KompasTabBar", profile, StringComparison.Ordinal);
        Assert.Contains("RoleFitCheckPanel", profile, StringComparison.Ordinal);
        Assert.Contains("Kompas.Title", profile, StringComparison.Ordinal);
