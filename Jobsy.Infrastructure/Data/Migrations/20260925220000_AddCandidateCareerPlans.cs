...
namespace Jobsy.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260925220000_AddCandidateCareerPlans")]
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DreamTitle = table.Column<string>(type: "character varying(120)", maxLength: 120, nullable: false),
                    DreamKey = table.Column<string>(type: "character varying(160)", maxLength: 160, nullable: false),
                    PlanJson = table.Column<string>(type: "text", nullable: false),
                    MatchPercent = table.Column<int>(type: "integer", nullable: false),
                    MatchSummary = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: false),
