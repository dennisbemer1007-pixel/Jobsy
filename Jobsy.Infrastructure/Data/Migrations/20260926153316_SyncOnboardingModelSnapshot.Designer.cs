...
namespace Jobsy.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260926153316_SyncOnboardingModelSnapshot")]
    partial class SyncOnboardingModelSnapshot
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Jobsy.Core.Entities.AgencyAnnualSubscription", b =>
                {
                    ...
                    b.HasIndex("CompanyId", "IsActive", "EndsAtUtc");

                    b.ToTable("AgencyAnnualSubscriptions", (string)null);
                });
            ...
            modelBuilder.Entity("Jobsy.Core.Entities.Application", b =>
                {
                    ...
                    b.Property<int>("CandidateReferenceCount")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Jobsy.Core.Entities.AtsScrapeSource", b =>
                {
                    ...
                    b.Property<DateTime?>("LastScrapedAtUtc")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.HasIndex("IsEnabled", "LastScrapedAtUtc");

                    b.ToTable("AtsScrapeSources", (string)null);
                });

            modelBuilder.Entity("Jobsy.Core.Entities.AtsScrapedListing", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("Status", "ScrapedAtUtc");

                    b.ToTable("AtsScrapedListings", (string)null);
                });
            ...
            modelBuilder.Entity("Jobsy.Core.Entities.CandidateCareerInterest", b =>
                {
                    ...
                    b.Property<int?>("ArtisticPercent")
                        .HasColumnType("integer");
                    ...
                    b.Property<int?>("EnterprisingPercent")
                        .HasColumnType("integer");
                    ...
                    b.Property<int?>("InvestigativePercent")
                        .HasColumnType("integer");
                    ...
                    b.Property<int?>("RealisticPercent")
                        .HasColumnType("integer");

                    b.Property<string>("RiasecTagsJson")
                        .IsRequired()
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)");

                    b.Property<int?>("SocialPercent")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Jobsy.Core.Entities.CandidateCompetency", b =>
                {
                    ...
                    b.Property<int?>("ExtraversiePercent")
                        .HasColumnType("integer");

                    b.Property<int?>("InnovatiePercent")
                        .HasColumnType("integer");
                    ...
                    b.Property<int?>("ResultaatgerichtheidPercent")
                        .HasColumnType("integer");
                    ...
                    b.Property<int?>("SamenwerkenPercent")
                        .HasColumnType("integer");
                    ...
                    b.Property<int?>("StressbestendigheidPercent")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Jobsy.Core.Entities.CandidateVacancyCultureFit", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("CandidateVacancyCultureFits", (string)null);
                });
            ...
            modelBuilder.Entity("Jobsy.Core.Entities.DeepAnalysisCheckout", b =>
                {
                    ...
                    b.ToTable("DeepAnalysisCheckouts", (string)null);
                });

            modelBuilder.Entity("Jobsy.Core.Entities.DeviceLoginHandoff", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Jobsy.Core.Entities.FlexCommercialSettings", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("BackofficePartnerName")
                        .IsRequired()
                        .HasMaxLength(128)
                        .HasColumnType("character varying(128)");
                    ...
                    b.ToTable("FlexCommercialSettings", (string)null);
                });
            ...
            modelBuilder.Entity("Jobsy.Core.Entities.IntegrationCredential", b =>
                {
                    ...
                    b.Property<bool>("IgnoreEnvironmentCredentials")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("Jobsy.Core.Entities.MarketingFlyerSettings", b =>
                {
                    ...
                    b.Property<string>("PromoDiscountText")
                        .IsRequired()
                        .HasMaxLength(400)
                        .HasColumnType("character varying(400)");

                    b.Property<string>("PromoFreeText")
                        .IsRequired()
                        .HasMaxLength(400)
                        .HasColumnType("character varying(400)");

                    b.Property<string>("QrCaption")
                        .IsRequired()
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)");
                    ...
                    b.ToTable("MarketingFlyerSettings");
                });
            ...
            modelBuilder.Entity("Jobsy.Core.Entities.PlatformFeedback", b =>
                {
                    ...
                    b.Property<DateTime?>("AutomationFinishedAtUtc")
                        .HasColumnType("timestamp with time zone");

                    b.Property<DateTime?>("AutomationLaunchedAtUtc")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.Property<DateTime?>("PromptEditedAtUtc")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.Property<byte[]>("ScreenshotBytes")
                        .HasColumnType("bytea");
                    ...
                    b.ToTable("PlatformFeedbacks", (string)null);
                });
            ...
            modelBuilder.Entity("Jobsy.Core.Entities.TalentContactRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<DateTime?>("ContactSharedAtUtc")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.Property<DateTime>("RespondByUtc")
                        .HasColumnType("timestamp with time zone");

                    b.Property<DateTime?>("RespondedAtUtc")
                        .HasColumnType("timestamp with time zone");

                    b.Property<Guid?>("SpendTransactionId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("RespondByUtc");

                    b.HasIndex("SpendTransactionId");

                    b.HasIndex("CompanyId", "CandidateUserId", "Status");

                    b.ToTable("TalentContactRequests", (string)null);
                });
            ...
            modelBuilder.Entity("Jobsy.Core.Entities.UserDeviceSession", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<DateTime?>("PreviousTokenGraceUntilUtc")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("Jobsy.Core.Entities.UserNotification", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Jobsy.Core.Entities.Vacancy", b =>
                {
                    ...
                    b.Property<DateTime?>("EngagementGoodwillExtendedAtUtc")
                        .HasColumnType("timestamp with time zone");

                    b.Property<DateTime?>("EngagementReminderSentAtUtc")
                        .HasColumnType("timestamp with time zone");

                    b.Property<string>("EngagementReminderTip")
                        .HasMaxLength(2000)
                        .HasColumnType("character varying(2000)");
                    ...
                    b.HasIndex("Status", "EngagementReminderSentAtUtc", "PublishedAtUtc");
            ...
            modelBuilder.Entity("Jobsy.Core.Entities.VacancyTranslation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("TranslatedJson")
                        .IsRequired()
                        .HasColumnType("text");
                    ...
                    b.HasIndex("VacancyId", "Language")
                        .IsUnique();

                    b.ToTable("VacancyTranslations", (string)null);
                });
            ...
            modelBuilder.Entity("Jobsy.Core.Entities.ApplicationUploadedCv", b =>
                {
                    b.HasOne("Jobsy.Core.Entities.Application", "Application")
                        .WithOne("UploadedCv")
                        .HasForeignKey("Jobsy.Core.Entities.ApplicationUploadedCv", "ApplicationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Jobsy.Core.Entities.AtsScrapeSource", b =>
                {
                    b.HasOne("Jobsy.Core.Entities.Company", "PreferredCompany")
                        .WithMany()
            ...
            modelBuilder.Entity("Jobsy.Core.Entities.AtsScrapedListing", b =>
                {
                    ...
                    b.HasOne("Jobsy.Core.Entities.AtsScrapeSource", "Source")
                        .WithMany("Listings")
            ...
            modelBuilder.Entity("Jobsy.Core.Entities.TalentContactRequest", b =>
                {
                    ...
                    b.HasOne("Jobsy.Core.Entities.User", "EmployerUser")
                        .WithMany()
                        .HasForeignKey("EmployerUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Jobsy.Core.Entities.TokenTransaction", "RefundTransaction")
                        .WithMany()
                        .HasForeignKey("RefundTransactionId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("Jobsy.Core.Entities.TokenTransaction", "SpendTransaction")
                        .WithMany()
                        .HasForeignKey("SpendTransactionId")
                        .OnDelete(DeleteBehavior.SetNull);
            ...
            modelBuilder.Entity("Jobsy.Core.Entities.WebPushSubscription", b =>
                {
                    b.HasOne("Jobsy.Core.Entities.UserDeviceSession", "DeviceSession")
                        .WithMany()
